          ...
          onload = function() {
            if (!document.all)
            {
              document.forms['theForm'].reset();
                ...
                <form action="http://www.kaisenbuy.com/flow.php" method="post" name="theForm" id="theForm" onsubmit="return checkConsignee(this)">
        <div class="flowBox">
...
<script type="text/javascript" src="/tongmeng/Public/Home/Js/transport.js"></script><table width="100%" align="center" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
  ...
  <tbody><tr>
    ...
    <td bgcolor="#ffffff"><input name="email" type="text" class="inputBg" id="email_0" value="admin@qq.com">
    (必填)</td>
  </tr>
