(function() {
    ...
    a.implement(Function, {
        $J_TYPE: "function",
        j19: function() {
            var c = $J.$A(arguments), b = this, d = c.shift();
            return function() {
    ...
    $J.Element = {
        ...
        j8: function() {
            if ($J.defined(document.documentElement.getBoundingClientRect)) {
                var c = this.getBoundingClientRect(), f = $j(document).j10(), h = $J.v.getDoc();
                return {
    ...
    $J.extend([ $J.Element, $J.Doc ], {
        j40: function(f, c) {
            var b = $J.getStorage(this.$J_UUID), d = b[f];
    ...
    $J.extend([ $J.Element, $J.Doc ], {
        a: function(f, d) {
            var h = "domready" == f ? false : true, c = this.j40("events", {});
            c[f] = c[f] || [];
        ...
        raiseEvent: function(f, c) {
            var j = "domready" == f ? false : true, i = this, h;
            if (!j) {
    ...
    $J.FX = new $J.Class({
        ...
        start: function(b) {
            ...
            this.timer = this.loop.j19(this).interval(Math.round(1e3 / this.options.fps));
...
MagicZoom.zoom.prototype = {
    ...
    show: function() {
        ...
        if (this.z48) {
            this.z48 = setTimeout(this.z9, 1e3 / this.options.fps);
        }
    },
    pause: function() {
        if (this.z48) {
